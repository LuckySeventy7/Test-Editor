 ...
 * @author Sergio
 */
public class SaveOrDiscardPopUp extends javax.swing.JFrame {

    /**
     * Creates new form SaveOrDiscardPopUp
     */
    public boolean saveState;
    public SaveOrDiscardPopUp() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaveOrDiscardPopUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SaveOrDiscardPopUp().setVisible(true);
            }
        });
    }
